...
public class ClipPagerTitleView extends View implements IMeasurablePagerTitleView {
    ...
    public ClipPagerTitleView(Context context, boolean vertical) {
        super(context);
    ...
    private void init(Context context) {
        ...
        if (vertical) {
        int paddingV = UIUtil.dip2px(context, 40);
            setPadding(paddingV, padding, paddingV, padding);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.w(VIEW_LOG_TAG,"WIDTH"+measuredWidth+",HEIGHT:"+measuredHeight);
    ...
    public int getContentBottom() {
      ...
      /*  if (vertical) {
            int contentWidth = mTextBounds.height();
            return getTop() + getHeight() / 2 + contentWidth / 2;
        }
...
*/
  ...
  /*      if (vertical) {
            ...
            float contentHeight = width - getLeft();
            return (int) (getWidth() / 2 - contentHeight / 2);
        }*/
