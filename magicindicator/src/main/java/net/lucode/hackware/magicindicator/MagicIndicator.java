...
public class MagicIndicator extends FrameLayout {
    ...
    public void setNavigator(IPagerNavigator navigator) {
        if (navigator instanceof CommonNavigator) {
            boolean vertical = ((CommonNavigator) navigator).isVerticalMode();
            setNavigator(navigator, vertical);
        } else {
    ...
    public void setNavigator(IPagerNavigator navigator, boolean vertical) {
        ...
        if (mNavigator instanceof View) {
            LayoutParams lp = vertical ? new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT) : new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
