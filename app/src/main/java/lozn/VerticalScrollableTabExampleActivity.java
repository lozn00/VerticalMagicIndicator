...
public class VerticalScrollableTabExampleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vertical_scrollable_indicator_example_layout);
...
/*        int padding = UIUtil.getScreenHeight(this) / 2;
    ...
    private void initMagicIndicator7() {
        ...
        CommonNavigator commonNavigator7 = new CommonNavigator(this,true);
    ...
    private void initMagicIndicator8() {
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            @Override
            public IPagerIndicator getIndicator(Context context) {
                WrapPagerIndicator indicator = new WrapPagerIndicator(context,true);
    ...
    private void initMagicIndicator9() {
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            @Override
            public IPagerIndicator getIndicator(Context context) {
                TriangularPagerIndicator indicator = new TriangularPagerIndicator(context,true);
