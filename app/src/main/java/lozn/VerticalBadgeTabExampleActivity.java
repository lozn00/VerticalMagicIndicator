...
public class VerticalBadgeTabExampleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_badge_vertical_tab_example_layout);
        mViewPager = (ViewPager) findViewById(R.id.view_pager);
        mViewPager.setAdapter(mExamplePagerAdapter);
        initMagicIndicator2V();
//        initMagicIndicator2V();
//        initMagicIndicator3V();
//        initMagicIndicator4V();
    }
    ...
    private void initMagicIndicator4V() {
        ...
        titleContainer.setDividerDrawable(new ColorDrawable() {
            ...
            public int getIntrinsicWidth() {
                return UIUtil.dip2px(VerticalBadgeTabExampleActivity.this, 15);
            }
        });
        ViewPagerHelper.bind(magicIndicator, mViewPager);
    }
